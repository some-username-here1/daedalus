...
void MatrixMultiplyUnaligned(Matrix4x4* m_out, const Matrix4x4* mat_a, const Matrix4x4* mat_b) // 8 byte aligned ?
{
	asm __volatile__(
		...
		"pcpyld		$t2, $t3, $t2	\n"
		"qmtc2		$t2, " VUR "vf8		\n"
		"vmulax.xyzw	" VUR "ACC, " VUR "vf5, " VUR "vf1	\n"
		"vmadday.xyzw	" VUR "ACC, " VUR "vf6, " VUR "vf1	\n"
		"vmaddaz.xyzw	" VUR "ACC, " VUR "vf7, " VUR "vf1	\n"
		"vmaddw.xyzw	" VUR "vf1, " VUR "vf8, " VUR "vf1	\n"
		"vmulax.xyzw	" VUR "ACC, " VUR "vf5, " VUR "vf2	\n"
		"vmadday.xyzw	" VUR "ACC, " VUR "vf6, " VUR "vf2	\n"
		"vmaddaz.xyzw	" VUR "ACC, " VUR "vf7, " VUR "vf2	\n"
		"vmaddw.xyzw	" VUR "vf2, " VUR "vf8, " VUR "vf2	\n"
		"vmulax.xyzw	" VUR "ACC, " VUR "vf5, " VUR "vf3	\n"
		"vmadday.xyzw	" VUR "ACC, " VUR "vf6, " VUR "vf3	\n"
		"vmaddaz.xyzw	" VUR "ACC, " VUR "vf7, " VUR "vf3	\n"
		"vmaddw.xyzw	" VUR "vf3, " VUR "vf8, " VUR "vf3	\n"
		"vmulax.xyzw	" VUR "ACC, " VUR "vf5, " VUR "vf4	\n"
		"vmadday.xyzw	" VUR "ACC, " VUR "vf6, " VUR "vf4	\n"
		"vmaddaz.xyzw	" VUR "ACC, " VUR "vf7, " VUR "vf4	\n"
		"vmaddw.xyzw	" VUR "vf4, " VUR "vf8, " VUR "vf4	\n"
		"qmfc2		$t0, " VUR "vf1	\n"
		"qmfc2		$t1, " VUR "vf2	\n"
		"qmfc2		$t2, " VUR "vf3	\n"
		"qmfc2		$t3, " VUR "vf4	\n"
